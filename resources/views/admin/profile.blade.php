        ...
        <div class="container">
            <div class="main-body">
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{asset('/')}}{{Auth::User()->image}}" id="imgPreview" alt="Admin"
                                ...
                                <ul class="list-group list-group-flush">
                                    <li
                                        ...
                                        <span class="text-secondary">{{ Auth::user()->website ?? 'N/A' }}</span>
                                    </li>
                                    <li
                                        class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        <h6 class="mb-0">
                                        ...
                                        <span class="text-secondary">{{ Auth::user()->github ?? 'N/A' }}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <form id="formSubmit" action="{{ url('admin/saveProfile') }}" method="POST"
