                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="card-body p-5">
                            ...
                            <div class="row mb-3">
                                <label for="enter_text" class="col-sm-3 col-form-label">Link</label>
                                <div class="col-sm-9">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" class="form-control " id="photo" placeholder="Upload Image"
                                        required>
                                </div>
                                <div id="image_key">
...
<script>
    function saveData(id, text, link, image) {
        ...
        if (image == '') {
            ...
            var key_image = "{{URL::asset('images')}}/" +
                image + "";
        }
        var html = ' <img src="' + key_image + '" name="images" id="imgPreview" height="200px" width="200px">';
        $('#image_key').html(html);
